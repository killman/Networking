...
class VideocacheOptions:
    ...
    def __init__(self, config_file = '/etc/videocache.conf', root = '/'):
        ...
        self.root = root
        self.youtube_format = { '240p' : [5], '360p' : [34, 18], '480p' : [35], '720p' : [22], '1080p' : [37], '3072p' : [38] }
        self.youtube_format_order = [ '240p', '360p', '480p', '720p', '1080p', '3072p' ]
        self.websites = ['youtube', 'aol', 'bing', 'bliptv', 'break', 'dailymotion', 'facebook', 'metacafe', 'myspace', 'vimeo', 'wrzuta', 'redtube', 'tube8', 'xtube', 'youporn']
        ...
        self.arg_drop_list = {'youtube': [], 'aol': [], 'bing': [], 'bliptv': ['start'], 'break': ['ec_seek'], 'dailymotion': ['start'], 'facebook': [], 'metacafe': [], 'myspace': [], 'vimeo': [], 'wrzuta': [], 'redtube': [], 'tube8': ['start'], 'xtube': ['start'], 'youporn': ['fs']}
    ...
    def initialize(self):
        ...
        try:
            ...
            self.__class__.id = 'e51695cbf98df40e24a812795c547096385c999f695cbf98df4'
